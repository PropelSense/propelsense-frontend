  ...
  return (
    <div className="flex h-screen bg-linear-to-b from-neutral-900 via-neutral-950 to-neutral-900">
      ...
      <aside className="w-64 bg-neutral-900/95 border-r border-neutral-800/50 flex flex-col">
        ...
        <div className="p-3">
          <Popover>
            <PopoverTrigger asChild>
              <button className="w-full flex items-center space-x-3 p-2 rounded-md hover:bg-neutral-800/60 transition-all focus:outline-none group">
                <Avatar className="w-9 h-9">
                  <AvatarFallback className="bg-linear-to-br from-zinc-600 to-zinc-700 text-white text-sm font-medium">
                    {getUserInitials()}
                  </AvatarFallback>
                </Avatar>
            ...
            <PopoverContent
              className="w-64 bg-zinc-900 border-zinc-700 p-3 ml-4"
              align="start"
            >
      ...
      <main className="flex-1 overflow-y-auto">
        <div className={activeItem === "vessel-traffic" ? "" : "p-8"}>
          {activeItem === "weather" ? (
            <WeatherDetails />
          ) : activeItem === "analytics" ? (
            <MarineWeather />
          ) : activeItem === "vessel-traffic" ? (
            <VesselMap />
